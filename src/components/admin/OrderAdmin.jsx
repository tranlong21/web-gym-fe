  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="p-6 max-w-7xl mx-auto w-full">
        ...
        <table className="w-full table-fixed border border-gray-300 shadow">
          <thead>
            <tr className="bg-gray-100">
              <th className="p-2 border border-gray-300 w-[5%] text-center">STT</th>
              <th className="p-2 border border-gray-300 w-[20%] text-center">Khách hàng</th>
              <th className="p-2 border border-gray-300 w-[20%] text-center">Trạng thái</th>
              <th className="p-2 border border-gray-300 w-[15%] text-center">Tổng tiền</th>
              <th className="p-2 border border-gray-300 w-[20%] text-center">Ngày đặt</th>
              <th className="p-2 border border-gray-300 w-[10%] text-center">Chi tiết</th>
            </tr>
          </thead>
          <tbody>
            {orders.map((order, idx) => (
              <React.Fragment key={order.id}>
                <tr className="hover:bg-gray-50 text-center">
                  ...
                  <td className="p-2 border border-gray-300">{order.total_money.toLocaleString()} đ</td>
                  <td className="p-2 border border-gray-300">{formatDate(order.order_date)}</td>
                  <td className="p-2 border border-gray-300">
                    <button
                ...
                {expandedOrderId === order.id && (
                  <tr className="bg-gray-50">
                    <td colSpan="6" className="p-4 border-t border-b border-gray-300">
